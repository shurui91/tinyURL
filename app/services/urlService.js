...
var getShortUrl = function(longUrl, callback) {
	...
	redisClient.get(longUrl, function(err, shortUrl) {
		...
		console.log(
			'this is redis url!!!! MY GODDDDDDDD!' +
				'long URL = ' +
				longUrl +
				'short URL = ' +
				shortUrl
		...
		if (shortUrl) {
			console.log(
				'getShortUrl bye bye mongo DB!  longUrl = ' +
					longUrl +
					'  shortUrl = ' +
					shortUrl
			);
			...
			urlModel.findOne({ longUrl: longUrl }, function(err, url) {
				...
				if (url) {
					...
					console.log(
						'urlService    getShortUrl  this is mongo DB long URL = ' +
							longUrl +
							'short URL = ' +
							shortUrl +
							'  url = ' +
					...
					console.log(
						'urlService    getShortUrl  this is mongo DB url type = ' +
							typeof url +
							'    !'
					);
					...
					generateShortUrl(function(shortUrl) {
						...
						console.log(
							'getShortUrl:  save into redis shortUrl = ' +
								shortUrl +
								' longUrl = ' +
								longUrl
						);
